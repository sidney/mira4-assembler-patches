		    ...
		    bool forcetakestronggood)
{
  ...
  BUGIFTHROW(megahublogname.empty(),"megahublogname.empty() ???");
 ...
 *************************************************************************/
//#define CEBUG(bla)   {cout << bla; cout.flush();}
void Skim::findPerfectRailMatchesInSkimFile(string & filename, const int8 rid2dir, vector<uint8> & prmatches)
{
  FUNCSTART("void Skim::findPerfectRailMatchesInSkimFile(string & filename, const int8 rid2dir, vector<uint8> & prmatches)");
 ...
 *************************************************************************/
//#define CEBUG(bla)   {cout << bla; cout.flush();}
void Skim::purgeUnnecessaryHitsFromSkimFile(string & filename, const int8 rid2dir, vector<uint8> & prmatches)
{
  FUNCSTART("void Skim::purgeUnnecessaryHitsFromSkimFile(string & filename, const int8 rid2dir, vector<uint8> & prmatches)");
...
//    SKIM3_empty_vector_vhrap_t.end()
  ...
  vhash_t acthash= (vaI->vhash & SKIM3_MAXVHASHMASK);
...
void Skim::selectPotentialHitsForSave2(const int8 direction, const uint32 actreadid, cfh_threaddata_t & cfhd)
{
  ...
  CEBUG("actreadid critlevel: " << static_cast<uint16>((*SKIM3_overlapcritlevell)[actreadid]) << " " << static_cast<uint16>(oclvr[actreadid]) << '\n');
