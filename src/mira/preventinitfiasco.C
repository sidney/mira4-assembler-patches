...
boost::unordered_set<std::string> Contig::CON_cebugnames;
...
boost::unordered_map<std::string,boost::regex> GFFParse::GFFP_regex_extractkeys;
...
std::vector<multitag_t::mte_id_t> DataProcessing::DP_freqnames;
const bool DataProcessing::DP_initialisedstatics=DataProcessing::priv_staticInitialiser();
